...
export default {
  ...
  // globalSetup: '<rootDir>/src/setup/test-setup.ts',

  // A path to a module which exports an async function that is triggered once after all test suites
  // globalTeardown: '<rootDir>/setup/end-test-setup.ts',
  ...
  testPathIgnorePatterns: ['<rootDir>/node_modules/', '<rootDir>/dist/', '<rootDir>/.vscode/', '<rootDir>/covarage/', '<rootDir>/prisma/'],
